...
class Vector:
	...
	Example usage: ( Vector(2, 5) + Vector(3, 1.5) ) * Vector(2, 1).getNormalized()
	...
	def distance(a, b):
		""" Calculates the distance between 2 Vectors
			...
			Returns: a number representing the distance between the to vectors (if they represent points in space)
		"""
	...
	def angle(v1, v2):
		""" Calculates the angle in Radian between 2 Vectors
			...
			Returns: a number in radian representing the angle between the to vectors.
		"""
	...
	def angleDeg(v1, v2):
		""" Calculates the angle in Degree between 2 Vectors
			...
			Returns: a number in degree representing the angle between the to vectors.
		"""
	...
	def dotproduct(self, other):
		""" Calculates the dot product between this vector and the given value.
			...
			Throws: NotImplemented for arguments of not accepted type
		"""
