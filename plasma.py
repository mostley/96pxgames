...
pretty easy realset_plasmamments explain my thinking... 
...
# ------------------------------------------------------------------------------------
def main():
    "Initializes display, precalculates the cosine values, and controls the update loop"
    ...
    cmap = set_palette(screen_surface)
    ...
    while 1:
        ...
        set_plasma_buffer(rgb, cmap, plasma_buffer)
        rgb.send()
